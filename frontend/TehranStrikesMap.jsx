...
const STRIKES = [
  ...
  {id:1,n:"Supreme Leader's Compound (Pasteur District)",lat:35.700,lng:51.423,c:"confirmed",d:"Feb 28",
   t:"Khamenei killed. Satellite confirms destruction.",
  ...
  {id:4,n:"Ministry of Intelligence — ×10 sites (D12)",lat:35.689,lng:51.389,c:"confirmed",d:"Feb 28–Mar 1",
   t:"IDF hit 10 MoI sites + 1 Quds Force site. Baseri & Rezaeian killed.",
  ...
  {id:8,n:"State Radio & TV HQ — IRIB ×3+ (D3)",lat:35.715,lng:51.406,c:"confirmed",d:"Feb 28–Mar 3",
   t:"Hit 3+ times. IRIB switched to internet streaming.",
  ...
  {id:12,n:"Gandhi Hospital (D3, Gandhi St)",lat:35.759,lng:51.410,c:"confirmed",d:"Mar 1",
   t:"Newborns evacuated. WHO condemned.",
  ...
  {id:13,n:"Assembly of Experts Building (D12, Baharestan Sq)",lat:35.6919,lng:51.4278,c:"confirmed",d:"Mar 2–3",
   t:"Struck during session. Also hit in Qom.",
   s:["Fars News","Tasnim News","Iranian state media","Iran International","Critical Threats"],cat:"Government"},
  ...
  {id:17,n:"Parchin Military Complex (Tehran Province, SE)",lat:35.520,lng:51.770,c:"confirmed",d:"Mar 3, 5, 7",
   t:"Hit multiple times. Missile warhead factories, Taleghan 2. IDF: 'most central' production sites.",
  ...
  {id:18,n:"Niloofar Sq / Police Station 104 (D7, Abbas Abad)",lat:35.705,lng:51.435,c:"confirmed",d:"Mar 2",
   t:"Double-tap. 20+ civilians killed. Police Stn 104 was target.",
   s:["Wikipedia","FDD","AP photo"],cat:"Civilian/Police"},
  ...
  {id:20,n:"Basij Headquarters (D11/12)",lat:35.695,lng:51.415,c:"confirmed",d:"Mar 3–4",
   t:"Basij HQ struck.",
   s:["Wikipedia","IDF","Al Jazeera"],cat:"Military"},
  ...
  {id:55,n:"Hospitals near Red Crescent building (D11/12)",lat:35.700,lng:51.415,c:"likely",d:"Mar 1",
   t:"Red Crescent reported explosions near hospitals & its Peace Building.",
   s:["Civilian sites list","Timeline wiki"],cat:"Civilian/Medical"},
