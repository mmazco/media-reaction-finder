...
const STRIKES = [
  ...
  {id:4,n:"Ministry of Intelligence — ×10 sites (D12)",lat:35.689,lng:51.389,c:"confirmed",d:"Feb 28–Mar 1",
   t:"HQ struck. IDF hit 10 MoI sites + 1 Quds Force site at night. Baseri & Rezaeian killed. Mar 22: IDF struck an additional Intelligence and Security Ministry HQ in Tehran.",
   s:["Al Jazeera","Fars News","IDF","Wikipedia","ISW"],cat:"Government"},
  ...
  {id:17,n:"Parchin Military Complex (Tehran Province, SE)",lat:35.520,lng:51.770,c:"confirmed",d:"Mar 3, 5, 7, 26, 29",
   t:"Hit multiple waves. Warhead factories, Taleghan 2. IDF: 'most central' production sites. CTP-ISW satellite confirms underground facility hit. Mar 26: massive wave with 60+ jets, 150 munitions targeting air defense, warheads, ballistic missile components. Mar 29: power transmission network struck, causing blackouts in Tehran/Karaj.",
   s:["IDF","Israeli analyst (sat imagery)","Critical Threats","ISW","CTP-ISW"],cat:"Military/Nuclear"},
  ...
  {id:22,n:"Mehrabad International Airport (D9)",lat:35.689,lng:51.311,c:"confirmed",d:"Mar 7, 11, 12+, Apr 4",
   t:"IDF destroyed 16 Quds Force aircraft. Major domestic airport. Ongoing targeting. Supreme Leader's aircraft destroyed (Alma Mar 16). Apr 4: struck again alongside Sepehr Intl and Shahid Aryafor airports.",
   s:["IDF","Al Jazeera","NDTV","Wikipedia","Alma Center","ISW"],cat:"Military/Transport"},
  ...
  {id:105,n:"LEC logistics & support division (D11, Tehran)",lat:35.695,lng:51.412,c:"confirmed",d:"Mar 18",
   t:"Law Enforcement Command logistics and support division struck as part of campaign against internal security apparatus.",
   s:["ISW","CTP-ISW","IDF"],cat:"Police/Military"},
  {id:106,n:"IRGC security unit HQ — protest suppression (W. Tehran)",lat:35.722,lng:51.342,c:"confirmed",d:"Mar 18–19",
   t:"IRGC security unit headquarters responsible for protest suppression in western Tehran struck.",
   s:["ISW","CTP-ISW"],cat:"Military/Security"},
  {id:107,n:"Police station, Tehranpars (D8, E. Tehran)",lat:35.745,lng:51.502,c:"confirmed",d:"Mar 18–19",
   t:"Law enforcement police station in the Tehranpars neighborhood of eastern Tehran struck.",
   s:["ISW","CTP-ISW"],cat:"Police"},
  {id:108,n:"Saba Battery Factory / Pasargad Industrial Town (Tehran Prov.)",lat:35.480,lng:51.080,c:"confirmed",d:"Mar 18",
   t:"Saba Battery Factory in Pasargad Industrial Town — produces components for air defense and missile systems. Off-map (south Tehran Province).",
   s:["ISW","IDF"],cat:"Military/Industrial"},
  {id:109,n:"Shahid Qadiri Factory — air defense systems (Tehran Prov.)",lat:35.490,lng:51.100,c:"confirmed",d:"Mar 18",
   t:"Factory producing air defense systems struck by combined force.",
   s:["ISW","IDF"],cat:"Military/Industrial"},
  {id:110,n:"Fath Air Base — helicopter squadron (SE Tehran Prov.)",lat:35.410,lng:51.650,c:"confirmed",d:"Mar 18",
   t:"Fath Air Base hosts an attack helicopter squadron. Located near Varamin, SE of Tehran.",
   s:["ISW"],cat:"Military/Transport"},
  {id:111,n:"IRGC intelligence building, Kakh Street (D12)",lat:35.688,lng:51.422,c:"confirmed",d:"Mar 20",
   t:"IRGC intelligence building on Kakh Street in central Tehran struck by IDF. Same day senior officials Naini, Ahmadi-Moghaddam, Ghorishi killed.",
   s:["ISW","IDF"],cat:"Government/Intelligence"},
  {id:113,n:"IRGC missile components complex & storage (Tehran)",lat:35.680,lng:51.385,c:"confirmed",d:"Mar 21",
   t:"IDF struck 5+ missile production sites in Tehran — including IRGC missile components complex and storage site.",
   s:["IDF","ISW"],cat:"Military/Industrial"},
  {id:114,n:"Defense Ministry missile fuel production (Tehran Prov.)",lat:35.540,lng:51.710,c:"confirmed",d:"Mar 21",
   t:"Defense Ministry-linked missile fuel production complex struck. Part of Mar 21 wave targeting 5+ missile sites.",
   s:["IDF","ISW"],cat:"Military/Industrial"},
  {id:115,n:"Malek Ashtar University, Tehran (D4, Lavizan)",lat:35.770,lng:51.490,c:"confirmed",d:"Mar 21",
   t:"Malek Ashtar University of Technology — Tehran campus in Lavizan. Defense and aerospace research programs linked to IRGC.",
   s:["ISW","IDF"],cat:"Military/Academic"},
  {id:116,n:"Research Institute of Petroleum (D3/6, Tehran)",lat:35.758,lng:51.412,c:"confirmed",d:"Mar 21",
   t:"Research Institute of Petroleum in Tehran struck.",
   s:["ISW"],cat:"Industrial/Academic"},
  {id:117,n:"Khojir Aerospace Complex — weapons production (E. Tehran)",lat:35.680,lng:51.710,c:"confirmed",d:"Mar 22",
   t:"MODAFL weapons production and storage site east of Tehran, likely Khojir Aerospace Complex. IDF satellite imagery confirms.",
   s:["IDF","ISW"],cat:"Military/Industrial"},
  {id:118,n:"Artesh base — training + missile storage (SW Tehran)",lat:35.630,lng:51.352,c:"confirmed",d:"Mar 22",
   t:"Artesh base used for personnel training and missile storage in SW Tehran struck.",
   s:["IDF","ISW"],cat:"Military"},
  {id:119,n:"IRGC Aerospace Force weapons production (W. Tehran)",lat:35.718,lng:51.310,c:"confirmed",d:"Mar 22",
   t:"IRGC Aerospace Force weapons production facility in western Tehran struck.",
   s:["IDF","ISW"],cat:"Military/Industrial"},
  {id:120,n:"Emergency command center — internal security (Tehran)",lat:35.695,lng:51.418,c:"confirmed",d:"Mar 22",
   t:"Emergency command center for internal security forces struck. Also struck additional Intelligence and Security Ministry HQ.",
   s:["IDF","ISW"],cat:"Government/Security"},
  {id:121,n:"IRGC Aerospace Force HQ (Shahrak-e Gharb, W. Tehran)",lat:35.760,lng:51.376,c:"confirmed",d:"Mar 23, Apr 7",
   t:"IRGC Aerospace Force headquarters. Struck Mar 23 and again Apr 7. Shahrak-e Gharb area.",
   s:["IDF","ISW","LiveUAMap"],cat:"Military"},
  {id:122,n:"IRGC Ground Forces HQ (E. Tehran)",lat:35.720,lng:51.508,c:"confirmed",d:"Mar 23",
   t:"IRGC Ground Forces Headquarters in eastern Tehran struck.",
   s:["IDF","ISW"],cat:"Military"},
  {id:123,n:"Iran Electronic Industries, Tajrish (D1, NE Tehran)",lat:35.805,lng:51.432,c:"confirmed",d:"Mar 23",
   t:"Facility of Iran Electronic Industries in Tajrish, NE Tehran. IEI is a major defense electronics manufacturer.",
   s:["IDF","ISW"],cat:"Military/Industrial"},
  {id:124,n:"Defense Ministry missile engine production (Tehran)",lat:35.682,lng:51.398,c:"confirmed",d:"Mar 29",
   t:"Defense Ministry missile engine production site struck as part of Mar 29 wave.",
   s:["IDF","ISW"],cat:"Military/Industrial"},
  {id:125,n:"Drone engine production site (Tehran)",lat:35.688,lng:51.382,c:"confirmed",d:"Mar 29",
   t:"Drone engine production site struck. Part of campaign to degrade Iran's drone manufacturing.",
   s:["IDF","ISW"],cat:"Military/Industrial"},
  {id:126,n:"Air defense system storage & production (Tehran)",lat:35.698,lng:51.425,c:"confirmed",d:"Mar 29",
   t:"Air defense system storage and production site struck.",
   s:["IDF","ISW"],cat:"Military/Industrial"},
  {id:127,n:"Al Araby media building (Tehran)",lat:35.715,lng:51.428,c:"confirmed",d:"Mar 29",
   t:"Building housing Qatari media outlet Al Araby (The New Arab) in Tehran struck.",
   s:["ISW","media reports"],cat:"Media"},
  {id:128,n:"Power transmission network, Parchin area",lat:35.525,lng:51.695,c:"confirmed",d:"Mar 29",
   t:"Power transmission network at Parchin Military Complex struck, causing blackouts in parts of Karaj and Tehran.",
   s:["ISW","Iranian reports"],cat:"Infrastructure"},
  {id:129,n:"IRGC Defense Industries building (Tehran)",lat:35.698,lng:51.410,c:"confirmed",d:"Mar 31",
   t:"IRGC Defense Industries building struck on Mar 31.",
   s:["IDF","ISW","Reuters"],cat:"Military/Industrial"},
  {id:130,n:"Old Iranian stock exchange — air defenses (Tehran)",lat:35.692,lng:51.418,c:"confirmed",d:"Mar 31",
   t:"Old Iranian stock exchange building targeted in strikes on air defense systems.",
   s:["IDF","ISW"],cat:"Military/Government"},
  {id:131,n:"MODAFL complex — advanced missile production (Tehran)",lat:35.678,lng:51.395,c:"confirmed",d:"Apr 1",
   t:"Ministry of Defense and Armed Forces Logistics complex for advanced missile production. Part of wave hitting ~15 weapons production sites.",
   s:["IDF","ISW"],cat:"Military/Industrial"},
  {id:132,n:"Pharmaceutical R&D — chemical weapons materials (Tehran)",lat:35.730,lng:51.448,c:"confirmed",d:"Apr 1",
   t:"Pharmaceutical R&D company struck. IDF claims link to chemical weapons materials production.",
   s:["IDF","ISW"],cat:"Military/Industrial"},
  {id:133,n:"Bridge 1B, Karaj — 8 killed, 95 injured (Nowruz)",lat:35.812,lng:50.985,c:"confirmed",d:"Apr 2",
   t:"US struck with 2 missiles in double-tap strike. 8 killed, 95+ injured — many civilians celebrating Sizdah Be-dar (Nowruz). US claimed military supply route; locals say unfinished, non-operational bridge.",
   s:["AP","BBC","Wikipedia","Al Jazeera","NPR","Dropsite News"],cat:"Infrastructure/Civilian"},
  {id:134,n:"LAPRI, Shahid Beheshti University (D1, Tehran)",lat:35.800,lng:51.396,c:"confirmed",d:"Apr 3",
   t:"Laser and Plasma Research Institute (LAPRI) at Shahid Beheshti University. Defense-related research on lasers, photonics, and plasma.",
   s:["ISW","Reuters","CTP-ISW"],cat:"Military/Academic"},
  {id:135,n:"IRIB station Jamaran (D1, N. Tehran)",lat:35.803,lng:51.438,c:"confirmed",d:"Apr 3",
   t:"IRIB radio/TV station in Jamaran, northern Tehran. Separate from main IRIB complex (#9).",
   s:["ISW","CTP-ISW"],cat:"Media/Government"},
  {id:136,n:"Sarallah Barracks (central Tehran)",lat:35.694,lng:51.420,c:"confirmed",d:"Apr 3",
   t:"Sarallah Barracks in central Tehran struck.",
   s:["ISW","CTP-ISW"],cat:"Military"},
  {id:137,n:"S-300 SAM site, Kahrizak (S. Tehran)",lat:35.520,lng:51.370,c:"confirmed",d:"Apr 4",
   t:"S-300 surface-to-air missile site in Kahrizak, south Tehran. IDF claims 80%+ of Iran's air defense systems destroyed.",
   s:["ISW","CTP-ISW"],cat:"Military"},
  // ── LIKELY (54) ──
  ...
  {id:112,n:"IRGC Shahid Borujerdi logistics HQ (Tehran)",lat:35.700,lng:51.438,c:"likely",d:"Mar 20",
   t:"Israeli OSINT account, citing FIRMS satellite hotspot data, assessed combined force struck the IRGC Shahid Borujerdi logistics support headquarters.",
   s:["Israeli OSINT"],cat:"Military"},
  {id:138,n:"Residential strikes, Poonak/Marzdaran (W. Tehran)",lat:35.743,lng:51.348,c:"likely",d:"Mar–Apr",
   t:"Dropsite News reports residential areas in Poonak and Marzdaran neighborhoods of western Tehran struck. Specific military targets unclear.",
   s:["Dropsite News","Iranian media"],cat:"Residential"},
  {id:139,n:"Residential strikes, Zafaranieh (N. Tehran)",lat:35.798,lng:51.432,c:"likely",d:"Mar–Apr",
   t:"Dropsite News reports residential strikes in Zafaranieh, affluent northern Tehran neighborhood.",
   s:["Dropsite News"],cat:"Residential"},
  {id:140,n:"Residential strikes, Shahr Rey (S. Tehran)",lat:35.585,lng:51.435,c:"likely",d:"Mar–Apr",
   t:"Dropsite News reports residential damage in Shahr Rey district of southern Tehran.",
   s:["Dropsite News"],cat:"Residential"},
  // ── UNVERIFIED (5) ──
...
const counts={confirmed:81,likely:54,unverified:5};
