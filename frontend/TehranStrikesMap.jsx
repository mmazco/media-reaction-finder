...
const STRIKES = [
  {id:1,n:"Supreme Leader's Compound (Pasteur District)",lat:35.700,lng:51.423,c:"confirmed",d:"Feb 28",
   t:"Khamenei's residence & office compound destroyed. Satellite imagery confirms severe damage. Khamenei, family & Shamkhani killed.",
  ...
  {id:2,n:"IRGC HQ / Thar-Allah Headquarters (D11)",lat:35.696,lng:51.416,c:"confirmed",d:"Feb 28",
   t:"IDF levelled General Staff of internal security & Thar-Allah HQ — command-and-control linking regime with ground forces.",
  ...
  {id:3,n:"University St / Jomhouri Area (D11)",lat:35.694,lng:51.405,c:"confirmed",d:"Feb 28",
   t:"Multiple missiles hit. Two students killed at nearby school east of the capital.",
  ...
  {id:4,n:"Ministry of Intelligence — ×10 sites (D12)",lat:35.689,lng:51.389,c:"confirmed",d:"Feb 28–Mar 1",
   t:"HQ struck. IDF confirmed it hit 10 MoI sites + 1 Quds Force site at night. Officials Baseri & Rezaeian killed.",
   s:["Al Jazeera","Fars News","IDF","Wikipedia","Iranian state media"],cat:"Government"},
  ...
  {id:6,n:"Seyyed Khandan (D3)",lat:35.744,lng:51.440,c:"confirmed",d:"Feb 28",
   t:"Explosions confirmed by Tasnim, cross-referenced by AJ.",
  ...
  {id:7,n:"Atomic Energy Org. of Iran (D6, Amirabad)",lat:35.720,lng:51.395,c:"confirmed",d:"Feb 28",
   t:"AEOI HQ targeted. Confirmed in AJ verified mapping report.",
  ...
  {id:8,n:"State Radio & TV HQ — IRIB ×3 (D3)",lat:35.715,lng:51.406,c:"confirmed",d:"Feb 28, Mar 1, Mar 3",
   ...
   s:["Iranian media","Wikipedia","IDF","Al Jazeera","Timeline wiki"],cat:"Government"},
  {id:9,n:"Azadi Tower / Azadi Square (D2)",lat:35.700,lng:51.338,c:"confirmed",d:"Mar 1",
   t:"CNN verified massive explosion footage around iconic tower.",
  ...
  {id:14,n:"SNSC + Presidential Office (Pasteur complex, D11)",lat:35.700,lng:51.424,c:"confirmed",d:"Mar 3",
   t:"~100 jets dropped 250+ bombs on 'leadership complex'. SNSC, Presidential Office, officer training institution.",
   s:["IDF","Critical Threats","Times of Israel","Israeli media"],cat:"Leadership"},
  {id:15,n:"'Minzadehei' Nuclear Compound (D4, outskirts)",lat:35.750,lng:51.550,c:"confirmed",d:"Mar 3",
   t:"Secret partially-underground nuclear weapons facility destroyed. Scientists tracked from June 2025 war.",
   s:["IDF","CNN","Times of Israel","JNS","Jerusalem Post","ABC","WION","Ynet","Critical Threats"],cat:"Nuclear"},
  {id:16,n:"Parchin Military Complex (Tehran Province, SE)",lat:35.520,lng:51.770,c:"confirmed",d:"Mar 3",
   t:"Underground facility struck. Munitions, drones, missiles & historic nuclear testing (Taleghan 2).",
   s:["Israeli analyst (sat imagery)","Critical Threats"],cat:"Military/Nuclear"},
  {id:17,n:"Niloofar Sq / Police Station 104 (D7, Abbas Abad)",lat:35.705,lng:51.435,c:"confirmed",d:"Mar 2",
   t:"Double-tap strike. 20+ civilians killed. Police Station 104 on Niloufar St was the target.",
   s:["Wikipedia","Iranian sources","FDD","AP photo"],cat:"Civilian/Police"},
  {id:18,n:"Golestan Palace area — UNESCO site (D12)",lat:35.680,lng:51.422,c:"confirmed",d:"Mar 1–2",
   t:"Debris from airstrike damaged UNESCO World Heritage Site. UNESCO condemned.",
   s:["CNN","Wikipedia (2026 Iran war)"],cat:"Heritage"},
  {id:19,n:"Basij Headquarters (D11/12)",lat:35.695,lng:51.415,c:"confirmed",d:"Mar 3–4",
   t:"Basij HQ struck. IDF confirmed targeting Basij buildings across Tehran.",
   s:["Wikipedia (2026 Iran war)","IDF","Al Jazeera"],cat:"Military"},
  {id:20,n:"Law Enforcement Command — FARAJA (D12)",lat:35.690,lng:51.400,c:"confirmed",d:"Mar 2",
   t:"FARAJA Law Enforcement Command building destroyed in Tehran.",
   s:["LiveUAMap","FDD"],cat:"Police"},
  {id:21,n:"Narmak / 72 Sq — Ahmadinejad area (D8)",lat:35.738,lng:51.487,c:"likely",d:"Feb 28",
   t:"Videos of strikes near Ahmadinejad residence. School damaged. Ahmadinejad confirmed dead.",
   s:["Al Jazeera","local authorities","Wikipedia"],cat:"Leadership"},
  {id:22,n:"IRGC Admin Building (D8, Narmak)",lat:35.740,lng:51.490,c:"likely",d:"Mar 2",
   t:"Separate from Ahmadinejad residence. Video shows missile striking IRGC admin building in Narmak.",
   s:["FDD (video posted Mar 2)"],cat:"Military"},
  {id:23,n:"Khatam-al-Anbia Hospital (D6)",lat:35.702,lng:51.422,c:"likely",d:"Mar 1",
   t:"Military-affiliated hospital. BBC Verify confirmed damage.",
   s:["BBC Verify","NPR","Wikipedia"],cat:"Civilian/Medical"},
  {id:24,n:"Tehran Revolutionary Court (D12)",lat:35.690,lng:51.410,c:"likely",d:"Feb 28–Mar 1",
   t:"Court reportedly destroyed per Iranian media.",
   s:["Wikipedia","Iranian media"],cat:"Government"},
  {id:25,n:"Milad Tower Area (D2)",lat:35.745,lng:51.375,c:"likely",d:"Mar 1",
   t:"Explosions near Iran's tallest tower.",
   s:["Wikipedia","Iranian media"],cat:"Landmark"},
  {id:26,n:"Ferdowsi Square (D12)",lat:35.6965,lng:51.4185,c:"likely",d:"Mar 2",
   t:"CGTN named alongside Tajrish in IAF's latest wave.",
   s:["CGTN","Pravda (images)","IDF"],cat:"Downtown"},
  {id:27,n:"Tajrish (D1, N. Tehran)",lat:35.800,lng:51.434,c:"likely",d:"Mar 2",
   t:"Named alongside Ferdowsi Sq in CGTN report.",
   s:["CGTN"],cat:"Mixed"},
  {id:28,n:"IRGC Malek-Ashtar Building (D4, Lavizan)",lat:35.770,lng:51.505,c:"likely",d:"Mar 2",
   t:"Video shows building completely destroyed.",
   s:["Iran International (video)","Wikipedia","FDD"],cat:"Military/Nuclear"},
  {id:29,n:"Central Prison Complex (D3, near IRIB)",lat:35.720,lng:51.412,c:"likely",d:"Mar 2",
   t:"AJ reported strikes near IRIB and central prison complex.",
   s:["Al Jazeera (video report)"],cat:"Government"},
  {id:30,n:"Majlis / Parliament (D12, Baharestan Sq)",lat:35.6919,lng:51.4278,c:"likely",d:"Mar 1–2",
   t:"Fars reported explosions; initial reports indicate parliament targeted.",
   s:["Fars News","Iranian state media","JFeed"],cat:"Government"},
  {id:31,n:"Ba'ath Hospital area (D13/14, E. Tehran)",lat:35.700,lng:51.480,c:"likely",d:"Mar 4",
   t:"Columns of smoke in eastern Tehran. Mehr images near Ba'ath Hospital.",
   s:["Tabnak","Entekhab","Mehr (images)"],cat:"Civilian/Medical"},
  {id:32,n:"Aryashahr Police Special Forces HQ (D2/5)",lat:35.700,lng:51.350,c:"likely",d:"Mar 2",
   t:"Police Special Forces HQ reportedly destroyed Mar 2.",
   s:["FDD (reports)"],cat:"Police"},
  {id:33,n:"Security Police building (D18, Yaftabad)",lat:35.660,lng:51.330,c:"likely",d:"Mar 2",
   t:"Images shared early hours of Mar 2 show building hit.",
   s:["FDD (social media images)"],cat:"Police"},
  {id:34,n:"Police Station 151 (D18, Yaftabad)",lat:35.658,lng:51.328,c:"likely",d:"Mar 2",
   t:"Completely destroyed Mar 2. Second Yaftabad police target.",
   s:["FDD"],cat:"Police"},
  {id:35,n:"Basij base (D16, Naziabad)",lat:35.655,lng:51.400,c:"likely",d:"Mar 2",
   t:"Basij base destroyed in Israeli airstrike per videos.",
   s:["FDD (videos & reports)"],cat:"Military"},
  {id:36,n:"Police Station 140 (D5, Bagh-e Feyz)",lat:35.755,lng:51.360,c:"likely",d:"Mar 3",
   t:"Video shows ruins of police station following airstrikes.",
   s:["FDD (video Mar 3)"],cat:"Police"},
  {id:37,n:"Sohrevardi district positions (D7)",lat:35.715,lng:51.440,c:"likely",d:"Mar 2",
   t:"Islamic Republic positions reportedly hit. Images circulated.",
   s:["FDD (images circulated)"],cat:"Military"},
  {id:38,n:"Zero-Six Military Garrison (D3, Pasdaran)",lat:35.760,lng:51.460,c:"likely",d:"Mar 3",
   t:"Military garrison in Pasdaran district struck.",
   s:["Timeline wiki","FDD"],cat:"Military"},
  {id:39,n:"Basij / Internal Security buildings (D2/5, W. Tehran)",lat:35.700,lng:51.360,c:"likely",d:"Mar 4",
   t:"IDF 'broad wave' Mar 4 targeting Basij & internal security command.",
   s:["IDF (press statement)","Al Jazeera"],cat:"Military"},
  {id:40,n:"Farmanieh Street (D1)",lat:35.787,lng:51.463,c:"unverified",d:"Mar 2",
   t:"LiveUAMap only (page 403'd). Target unknown.",
   s:["LiveUAMap"],cat:"Unknown"},
  {id:41,n:"Sepah Square (D12)",lat:35.681,lng:51.421,c:"unverified",d:"Mar 2",
   t:"Single source aggregation.",
   s:["Iranian media via LiveUAMap"],cat:"Unknown"},
  {id:42,n:"Khazaneh / Basij Bokharaei Base (D18)",lat:35.620,lng:51.440,c:"unverified",d:"Mar 2",
   t:"Presumably IRGC base. No wire service mention.",
   s:["LiveUAMap"],cat:"Military"},
  {id:43,n:"Evin District — IDF evacuation warning (D1)",lat:35.805,lng:51.394,c:"unverified",d:"Mar 3–4",
   t:"IDF issued evacuation warning. Prison admin collapsed. Strike expected.",
   s:["IDF (evac warning)","NCRI"],cat:"Government/Prison"},
  {id:44,n:"IRGC Compound — SE Tehran (ISW-identified, Mar 4)",lat:35.665,lng:51.455,c:"likely",d:"Mar 4",
   t:"ISW identified IDF strikes on SE Tehran military compound housing IRGC Ground Forces, Navy, Quds Force, Basij Organization & Intelligence Organization HQs. Possibly also IRGC Central Defense Command Center (~1.5km from IRGC HQ). Strikes aimed at disrupting command-and-control.",
   s:["ISW","IDF"],cat:"Military"},
];

const TIER1=["AP","AP photo","Reuters"],TIER2=["CNN","BBC","BBC Verify","Al Jazeera","Al Jazeera (video)","Al Jazeera (video report)","NPR","CBS","ABC","Anadolu Agency","TRT World","Times of Israel","Jerusalem Post","JNS","Globe and Mail","Middle East Eye","NDTV","WION","Ynet","ISW","Iran International","Critical Threats","Israeli analyst","Israeli analyst (sat imagery)","Israeli media","JFeed"],TIER3=["Fars News","Tasnim News","Iranian state media","Iranian media","IRNA","ISNA","CGTN","Iranian sources","NCRI","Mehr","Tabnak","Entekhab","Wikipedia","Wikipedia (2026 Iran war)","Timeline wiki","local authorities"],TIER4=["LiveUAMap","Iranian media via LiveUAMap","Pravda (images)","FDD","FDD (reports)","FDD (video posted Mar 2)","FDD (social media images)","FDD (videos & reports)","FDD (video Mar 3)","FDD (images circulated)"],OFFICIAL=["IDF","IDF (press statement)","IDF (evac warning)","CENTCOM"];
